...
def discovery(host, username, password, enable_secret):
    ...
    log_file = open("Output/Network Discovery/" + filename, "a")
...
def health_checks(ip):
    CURRENT_DIR = "Output/Traceroute Results/"
...
def main():
    ...
    elif option == "Show CDP Neighbour":
        csv_name = "Inventory/Network/Network_FIEP.csv"
        with open(csv_name, "r") as read_obj:
            csv_reader = reader(read_obj)
            list_of_rows = list(csv_reader)
            ...
            while rows >= 2:
                ...
                if ip_ping == None:
                    fileName = "DOWN_" + dt_string + ".txt"
                    downDeviceOutput = open(
                        "Output/CDP Neighbour/" + fileName, "a")
                    downDeviceOutput.write(str(ip) + "\n")
                else:
                    select_enclave()
                    cdp_neighbour(
        ...
        with open(csv_name, "r") as read_obj:
            ...
            while rows >= 2:
                ...
                if ip_ping == None:
                    fileName = "DOWN_" + dt_string + ".txt"
                    downDeviceOutput = open(
                        "Output/Network Discovery/" + fileName, "a")
                    downDeviceOutput.write(str(ip) + "\n")
                else:
                    select_enclave()
                    discovery(
    ...
    elif option == "Save Running Config":
        csv_name = "Inventory/Network/Network_FIEP.csv"
        with open(csv_name, "r") as read_obj:
            csv_reader = reader(read_obj)
            list_of_rows = list(csv_reader)
    ...
    elif option == "Show IP Interface Brief":
        csv_name = "Inventory/Network/Network_FIEP.csv"
        with open(csv_name, "r") as read_obj:
            csv_reader = reader(read_obj)
            list_of_rows = list(csv_reader)
            ...
            while rows >= 2:
                ...
                if ip_ping == None:
                    fileName = "DOWN_" + dt_string + ".txt"
                    downDeviceOutput = open(
                        "Output/Interface Brief/" + fileName, "a")
                    downDeviceOutput.write(str(ip) + "\n")
                else:
                    select_enclave()
                    int_brief(
    ...
    elif option == "Show Interface Description":
        csv_name = "Inventory/Network/Network_FIEP.csv"
        with open(csv_name, "r") as read_obj:
            csv_reader = reader(read_obj)
            list_of_rows = list(csv_reader)
            ...
            while rows >= 2:
                ...
                if ip_ping == None:
                    fileName = "DOWN_" + dt_string + ".txt"
                    downDeviceOutput = open(
                        "Output/Interface Description/" + fileName, "a")
                    downDeviceOutput.write(str(ip) + "\n")
                else:
                    select_enclave()
                    int_desc(
    ...
    elif option == "Ping Devices":
        select_enclave()
        ping_devices()

    elif option == "Trace Route":
        csv_name = "Inventory/Network/Network_FIEP.csv"
        with open(csv_name, "r") as read_obj:
            csv_reader = reader(read_obj)
            list_of_rows = list(csv_reader)
            ...
            while rows >= 2:
                ...
                if ip_ping == None:
                    fileName = "DOWN_" + dt_string + ".txt"
                    downDeviceOutput = open(
                        "Output/Traceroute Results/" + fileName, "a")
                    downDeviceOutput.write(str(ip) + "\n")
                else:
                    select_enclave()
                    tracert()
